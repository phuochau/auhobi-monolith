...
import { VehicleModel } from "src/modules/vehicle/entities/vehicle-model.entity";
...
export class ImportCarsBaseModels1730643801705 implements MigrationInterface {
