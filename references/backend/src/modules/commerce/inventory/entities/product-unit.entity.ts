...
@Entity({ name: `${TABLE_PREFIX}_product_units` })
export class ProductUnit extends BaseClass {
  @FilterableField(() => ID)
  ...
  @OneToMany(() => Product, item => item.unit)
  products: Product[];
...
@InputType()
export class ProductUnitDTO extends BaseClass {
