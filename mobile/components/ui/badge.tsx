...
const badgeVariants = cva(
  'web:inline-flex items-center rounded-md border border-border px-2 py-1 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2',
  {
    variants: {
      variant: {
